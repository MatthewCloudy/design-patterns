...
namespace Adapter
{
    ...
    public class AdapterMovieR4 : ITarget
    {
        ...
        public string author
        {
            get
            {
                return movie.d[authors[movie.director].name] + " " + movie.d[authors[movie.director].surname];
            }
        }
        ...
        public int authorYear
        {
            get
            {
                return Int32.Parse(movie.d[authors[movie.director].birthYear]);
            }
        }
        ...
        public string releaseYear
        {
            get
            {
                return movie.d[movie.releaseYear];
            }
        }
    ...
    public class AdapterSeriesR4 : ITarget
    {
        ...
        public string author
        {
            get
            {
                return serie.d[authors[serie.showrunner].name] + " " + serie.d[authors[serie.showrunner].surname];
            }
        }
        ...
        public int authorYear
        {
            get
            {
                return Int32.Parse(serie.d[authors[serie.showrunner].birthYear]);
            }
        }
    ...
    public class AdapterEpisodeR4 : ITarget
    {
        ...
        public string title
        {
            get
            {
                return episode.d[episode.title];
            }
        }
        ...
        public string author
        {
            get
            {
                return episode.d[authors[episode.director].name];
            }
        }
        ...
        public int authorYear
        {
            get
            {
                return Int32.Parse(episode.d[authors[episode.director].birthYear]);
            }
        }
        ...
        public string releaseYear
        {
            get
            {
                return episode.d[episode.releaseYear];
            }
        }
