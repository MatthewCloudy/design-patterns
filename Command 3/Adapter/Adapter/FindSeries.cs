...
{
    // Find series - factory
    public class CreateCommandFindSeries : ICommandFactory
    {
        public string commandName => "find series";
        ...
        public ICommand CreateCommand(string commandText, Dictionary<string, object> d)
        {
            ...
            command = new CommandFindSeries(d, commandText, requirementsList);

            return command;
        }
    }

    // Find series base - command
    public class CommandFindSeries : ICommand
    {
        ...
        public CommandFindSeries(Dictionary<string, object> d, string commandText, List<(string, string, char)> requirementsList)
        {
            this.d = d;
        ...
        public void Execute()
        {
            List<ISeries> collectionRestricted = new List<ISeries>();
            ...
            Console.WriteLine("------------------------------------Found series begin------------------------------------");
            ...
            Console.WriteLine("------------------------------------Found series end--------------------------------------");
        }
